...
export default function DeliveryDashboard() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#e6f2ec] to-[#cde3d8] text-gray-800 font-sans">
      {/* Header */}
      <header className="p-6">
        <h1 className="text-xl font-semibold">Bine ai revenit</h1>
        <p className="text-lg text-[#2e7d32] font-bold">Bogdan Ion</p>
        <p className="mt-1 text-sm text-gray-600">Ai 1 livrare în progres</p>
      </header>

      {/* Livrare activă */}
      <section className="mx-4 mb-6 p-4 rounded-xl bg-white shadow-md border border-gray-200">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm font-medium text-gray-500">Cod livrare</span>
          <span className="text-sm font-semibold text-green-700">DLVR123454</span>
        </div>
      ...
      {/* Opțiuni livrare */}
      <section className="mx-4 mb-6 grid gap-4">
      ...
      <section className="mx-4 mb-24">
        <h2 className="text-lg font-semibold mb-2">Istoric</h2>
